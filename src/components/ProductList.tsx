...
function SkeletonProduct() {
  return (
    <div className="card shadow-xl m-2 x">
      ...
      <div className="card shadow-xl m-2">
        <figure className="h-72 bg-white">
          <img
            src={data.image}
            alt={data.title}
            className="max-h-[60%] sm:w-1/2 hover:scale-110 ease-linear duration-200"
          />
        </figure>
        <div className="card-body h-52">
  ...
  return (
    <div>
      ...
      <div
        ...
        className="p-4 sm:overflow-visible xl:container mx-auto"
        ref={productListComp}
      >
        <div
